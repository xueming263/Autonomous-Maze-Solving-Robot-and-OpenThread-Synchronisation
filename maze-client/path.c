...
// this code not used in the second robot car 
// keep only for debuging in the group and increase 
// portability


// dir is current turning direction
...
// overwrite the turning direction char when meet deadend
